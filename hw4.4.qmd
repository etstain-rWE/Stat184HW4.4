...
```{r}
#| label: setup-style-guide
#| echo: true
#| eval: false

# Coding style declaration:
# This document follows the Tidyverse Style Guide.
# https://style.tidyverse.org/
#
# Conventions used throughout this document include:
# - snake_case naming
# - readable object names
# - consistent indentation
# - clear pipe-based transformations
# - spacing around operators and arguments
```
...
![Passenger traffic trends for six major airports from 2020 to 2025.](images/airport_plot.png){fig-alt="Line graph showing passenger traffic trends for six major airports from 2020 to 2025, with one line per airport."}

![Summary table of passenger traffic for six major airports from 2020 to 2025.](images/airport_table.png){fig-alt="Formatted summary table listing passenger counts for six major airports across the years 2020 through 2025."}

The airport data were collected from a publicly accessible Wikipedia page, which makes the data collection process transparent and reproducible.
...
![Monte Carlo small multiple plots across increasing sample sizes.](images/mc_plot.png){fig-alt="Four-panel Monte Carlo integration visualization comparing estimates at sample sizes 10, 100, 1000, and 10000."}
...
The calcium dataset used in this analysis is included in the repository as `calcium.csv`, which helps make the workflow self-contained and reproducible.
...
![Mean calcium levels over time by group.](images/calcium_mean.png){fig-alt="Line plot showing mean calcium levels across years 0 to 3 for the control and treatment groups."}

![Individual calcium trajectories by group.](images/calcium_spaghetti.png){fig-alt="Spaghetti plots showing individual calcium trajectories over time, faceted by control and treatment groups."}

![Calcium distributions by year and group.](images/calcium_box.png){fig-alt="Grouped boxplots comparing calcium distributions across years for the control and treatment groups."}
